...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_32__badge_item_badge_item_component__["a" /* BadgeItemComponent */],
        ],
        imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile_service__ = __webpack_require__(68);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BadgeItemComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BadgeItemComponent = (function () {
    ...
    BadgeItemComponent.prototype.ngAfterViewInit = function () {
        $('div[data-html]').popup();
    };
    return BadgeItemComponent;
}());
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('badge'),
    __metadata("design:type", Object)
], BadgeItemComponent.prototype, "badge", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile_service__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_router__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng2_tour__ = __webpack_require__(423);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng2_tour___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_ng2_tour__);
...
var HomeComponent = (function () {
    function HomeComponent(router, ps, us, ts) {
        this.router = router;
        this.ps = ps;
        this.us = us;
        this.ts = ts;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__profile_service__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_service__ = __webpack_require__(31);
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.launchModal = function () {
...
var ProfileService = (function () {
    ...
    ProfileService.prototype.getAllBadges = function (uid) {
        return __WEBPACK_IMPORTED_MODULE_2_rxjs__["Observable"].combineLatest(this.af.database.list('badge'), this.af.database.object("users/" + uid + "/progress/actions"), function (badges, actions) {
            badges.forEach(function (badgeItem) {
                ...
                Object.keys(badgeItem.condition).forEach(function (key) {
                    if (actions[key] == undefined)
                        actions[key] = 0;
                    if (actions[key] < badgeItem.condition[key])
                        enableFlag = false;
                    if (badgeItem.condition[key] == 0)
                        return;
                    var starNum = Math.round(actions[key] * 5 / badgeItem.condition[key]);
    ...
    ProfileService.prototype.getAwardedBadges = function (uid) {
    ...
    ProfileService.prototype.getUpdateBadgeList = function (uid) {
        return this.getAwardedBadges(uid).switchMap(function (badgeList) {
            return this.getAllBadges().map(function (badges) {
                var updateList = [];
                badges.forEach(function (badgeItem) {
                    if (badgeItem.enabled && !contains(badgeList, badgeItem))
                        updateList.push(badgeItem);
                });
                return updateList;
            });
        }.bind(this));
